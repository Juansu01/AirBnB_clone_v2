...
def odd_or_even(n):
    """ Returns a page with odd or even number """
    if n % 2 == 0:
        my_string = "Number: {} is even".format(n)
    else:
        my_string = "Number: {} is odd".format(n)
    return render_template("6-number_odd_or_even.html", my_string=my_string)
